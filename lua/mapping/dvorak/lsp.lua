...
vim.api.nvim_set_keymap('n', 'ee', '<cmd>lua vim.diagnostic.goto_next()<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'EE', '<cmd>lua vim.diagnostic.goto_prev()<CR>', { noremap = true, silent = true })
